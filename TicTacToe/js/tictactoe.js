...
function placeXOrO(squareNumber) {
    ...
    //.some() checks each element of the selectSquare array to see if it contains the square number clicked on.
    ...
    //If a square has already been selected, return false.
    return false;
}
...
//your placement sound ('./media/place.mp3')
...
function resetGame() {
    ...
    selectedSquares = [];
//This resets our active player to 'X' so that X always starts first.
// (No need to reassign here, handled in resetGame if needed)ctive player to 'X' so that X always starts first.
activePlayer = 'X';
}